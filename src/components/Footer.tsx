...
import ImpliquezVousDialog from "@/components/ImpliquezVousDialog";
import FaireDonDialog from "@/components/FaireDonDialog";

const Footer = () => {
  const [impliquezVousOpen, setImpliquezVousOpen] = useState(false);
  const [faireDonOpen, setFaireDonOpen] = useState(false);

  return (
    <>
      <ImpliquezVousDialog open={impliquezVousOpen} onOpenChange={setImpliquezVousOpen} />
      <FaireDonDialog open={faireDonOpen} onOpenChange={setFaireDonOpen} />
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col items-center justify-center gap-6 sm:flex-row sm:gap-8">
              <Button 
                ...
                onClick={() => setImpliquezVousOpen(true)}
              >
                S'IMPLIQUER
              </Button>
